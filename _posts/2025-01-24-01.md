...
#### **퀴즈 1. 클라우드 컴퓨팅의 주요 이점 중 하나가 아닌 것은 무엇인가요?**
...
#### **퀴즈 2. Microsoft Azure에서 지역(Region)의 주요 목적은 무엇인가요?**
...
#### **퀴즈 3. Azure Portal에서 사용자가 할 수 없는 작업은 무엇인가요?**
...
#### **퀴즈 4. Azure의 IaaS(Infrastructure as a Service) 솔루션에 해당하는 것은 무엇인가요?**
...
#### **퀴즈 5. Azure의 비용 관리 기능으로 할 수 없는 작업은 무엇인가요?**
...
**정답:** 4
**해설:**
클라우드 컴퓨팅은 데이터 보안 문제를 증가시키는 것이 아니라 오히려 강화된 보안 솔루션을 제공합니다. 비용 효율성, 확장성, 빠른 배포는 클라우드 컴퓨팅의 주요 장점 중 일부입니다.

------

**정답:** 2
**해설:**
Azure의 지역(Region)은 리소스가 물리적으로 배치될 위치를 정의합니다. 이는 서비스의 성능과 규정 준수 요구 사항을 충족시키는 데 중요한 역할을 합니다.

------

**정답:** 4
**해설:**
Azure Portal은 리소스 관리 및 설정을 위한 그래픽 인터페이스를 제공하지만, 코딩 작업은 별도의 도구(예: Visual Studio Code)나 개발 환경에서 수행됩니다.

------

**정답:** 1
**해설:**
Azure Virtual Machines는 IaaS 솔루션으로, 가상 서버를 제공하여 사용자가 운영 체제 및 애플리케이션을 설치하고 관리할 수 있습니다. 다른 옵션은 PaaS(Platform as a Service) 또는 SaaS(Software as a Service)에 해당합니다.

------

**정답:** 4
**해설:**
Azure 비용 관리 기능은 비용 예산 설정, 사용량 분석, 비용 절감 제안을 포함하지만, 서비스의 성능 최적화는 별도의 서비스나 도구(예: Azure Monitor)로 수행됩니다.
